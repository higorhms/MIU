...
public class DataAccessFacade implements DataAccess {
    ...
    public static DataAccessFacade getInstance() {
        if (instance == null) instance = new DataAccessFacade();
        return instance;
    }
    ...
    public void saveNewMember(String id, String firstName, String lastName, String phoneNumber, String street, String city, String state, String zip) {
        CheckoutRecord record = new CheckoutRecord();
        Address address = new Address(street, city, state, zip);
        LibraryMember member = new LibraryMember(id, firstName, lastName, phoneNumber, address, record);
    ...
    public Book searchBook(String isbn) {
        for (Book b : readBooksMap().values())
    ...
    public LibraryMember searchMember(String memberId) {
        ...
        for (String id : readMemberMap().keySet()) {
            LibraryMember m = map.get(id);
