...
public class Test {
	//Expected output: [333-7806, 347-1111, 717-1235, 802-5716, 923-8756, 989-1256]
	public static void main(String[] args) {
		...
		CheckoutRecordEntry[] entries = {
				...
				new CheckoutRecordEntry(cds[0], LocalDate.of(2015, 1, 1),LocalDate.of(2015, 3, 1), ItemType.CD),
				...
				new CheckoutRecordEntry(cds[1], LocalDate.of(2015, 1, 1),LocalDate.of(2015, 3, 1), ItemType.CD),
				new CheckoutRecordEntry(cds[4], LocalDate.of(2017, 1, 12),LocalDate.of(2017, 3, 12), ItemType.CD)
		};
